...
modifies #NULL.base, #NULL.offset, #valid, ~x~0, ~#level~0.base, ~#level~0.offset, ~#last_to_enter~0.base, ~#last_to_enter~0.offset, ~#thr_num_array~0.base, ~#thr_num_array~0.offset, ~fairness_label_num~0, ~fairness_label_verified~0, ~fairness_label_end~0, #memory_int, #length, #pthreadsForks;
