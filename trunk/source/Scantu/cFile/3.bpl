...
modifies #pthreadsForks, #valid, #length, #memory_int, #NULL.base, #NULL.offset, ~x~0, ~#level~0.base, ~#level~0.offset, ~#last_to_enter~0.base, ~#last_to_enter~0.offset, ~#thr_num_array~0.base, ~#thr_num_array~0.offset, ~fairness_label_num~0, ~fairness_label_verified~0, ~fairness_label_end~0;
...
implementation ULTIMATE.start() returns (){
  ...
  $Ultimate##0:
    ...
    #valid := #valid[0 := 0];
    ~x~0 := 0;
    call ~#level~0.base, ~#level~0.offset := #Ultimate.allocOnStack(12);
    ...
    call ~#last_to_enter~0.base, ~#last_to_enter~0.offset := #Ultimate.allocOnStack(8);
    ...
    call ~#thr_num_array~0.base, ~#thr_num_array~0.offset := #Ultimate.allocOnStack(12);
  ...
  ULTIMATE.init_returnLabel:
    ...
    havoc main_#res;
    havoc main_#t~post9, main_~i~1, main_#t~pre10, main_#t~nondet11, main_#t~pre12, main_#t~nondet13, main_#t~pre14, main_#t~nondet15, main_#t~mem16, main_#t~mem17, main_#t~mem18, main_~#t0~0.base, main_~#t0~0.offset, main_~#t1~0.base, main_~#t1~0.offset, main_~#t2~0.base, main_~#t2~0.offset;
    main_~i~1 := 0;
    goto $Ultimate##1;
  $Ultimate##1:
  ...
  $Ultimate##6:
    ...
    call main_#t~mem16 := read~int(main_~#t0~0.base, main_~#t0~0.offset, 8);
    join main_#t~pre10;
    call main_#t~mem17 := read~int(main_~#t1~0.base, main_~#t1~0.offset, 8);
    join main_#t~pre12;
    call main_#t~mem18 := read~int(main_~#t2~0.base, main_~#t2~0.offset, 8);
    join main_#t~pre14;
    main_#res := 0;
