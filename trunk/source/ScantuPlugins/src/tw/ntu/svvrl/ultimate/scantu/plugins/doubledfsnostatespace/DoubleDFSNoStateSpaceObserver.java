...
public class DoubleDFSNoStateSpaceObserver implements IUnmanagedObserver {
	...
	public DoubleDFSNoStateSpaceObserver(final IUltimateServiceProvider services) {
		mServices = services;
	...
	public void finish() throws Throwable {
		...
		RunDoubleDFSNoStateSpace rddfsr = new RunDoubleDFSNoStateSpace(mLogger, mModelCheckerAssistant);
		rddfsr.run();
	}
