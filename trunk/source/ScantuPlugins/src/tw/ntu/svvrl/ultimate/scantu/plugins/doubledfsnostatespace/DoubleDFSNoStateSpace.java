...
public class DoubleDFSNoStateSpace implements IGenerator {
	
	private IUltimateServiceProvider mServices;
	private DoubleDFSNoStateSpaceObserver mObserver;
	...
	public List<IObserver> getObservers() {
		if (mUseObserver) {
			if (mObserver == null) {
				mObserver = new DoubleDFSNoStateSpaceObserver(mServices);
			}
